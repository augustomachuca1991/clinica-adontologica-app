        ...
        <div className="p-6 space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-foreground mb-2">
                {t("records.recordsModal.tabs.clinicalNotes.noteType")}
              </label>
                ...
                {[
                  {
                    key: "progress",
                    label: t(
                      `records.recordsModal.tabs.clinicalNotes.noteTypeOptions.progress`
                    ),
                    icon: "Activity",
                  },
                  {
                    key: "treatment",
                    label: t(
                      `records.recordsModal.tabs.clinicalNotes.noteTypeOptions.treatment`
                    ),
                    icon: "Stethoscope",
                  },
                  {
                    key: "observation",
                    label: t(
                      `records.recordsModal.tabs.clinicalNotes.noteTypeOptions.observation`
                    ),
                    icon: "Eye",
                  },
                  {
                    key: "followUp",
                    label: t(
                      `records.recordsModal.tabs.clinicalNotes.noteTypeOptions.followUp`
                    ),
                    icon: "CalendarDays",
                  },
                ]?.map(({ key, label, icon }) => (
            ...
            <div>
              <label className="block text-sm font-medium text-foreground mb-2">
                {t("records.recordsModal.tabs.clinicalNotes.quickTemplates")}
              </label>
              <div className="space-y-2">
                <Button
                  variant="outline"
                  ...
                  onClick={() =>
                    setNoteData((prev) => ({
                      ...prev,
                      content: t(
                        "records.recordsModal.tabs.clinicalNotes.postProcedureQuick"
                      ),
                    }))
                  }
                >
                ...
                <Button
                  ...
                  onClick={() =>
                    setNoteData((prev) => ({
                      ...prev,
                      content: t(
                        "records.recordsModal.tabs.clinicalNotes.followUpQuick"
                      ),
                    }))
                  }
                >
          ...
          <div>
            ...
            <textarea
              ...
              placeholder={t(
                "records.recordsModal.tabs.clinicalNotes.placeholder"
              )}
              rows={8}
            ...
            <p className="text-xs text-muted-foreground mt-2">
              {t("records.recordsModal.tabs.clinicalNotes.characters", {
                count: noteData?.content?.length || 0,
              })}
            </p>
          </div>

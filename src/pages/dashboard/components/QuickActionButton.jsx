...
const QuickActionButton = ({ icon, label, onClick, color = "var(--color-primary)" }) => {
  return (
    ...
    >
      <div className="w-12 h-12 md:w-14 md:h-14 rounded-lg flex items-center justify-center mb-3 transition-transform duration-base group-hover:scale-110" style={{ backgroundColor: `${color}15` }}>

        ...
        <div className="flex-1 min-w-0">
          <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-3 md:gap-4 mb-4">
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm md:text-base text-muted-foreground mb-3 md:mb-4">Patient ID: {patient?.patientId}</p>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
                <div className="flex items-center gap-2">
                  <Icon name="Calendar" size={16} className="text-primary flex-shrink-0" />
                  <div className="min-w-0">
                    <p className="text-xs text-muted-foreground">Age</p>
                    <p className="text-sm md:text-base font-medium text-foreground truncate">{calculateAge(patient?.dateOfBirth)} years</p>
                  </div>
                </div>
                <div className="flex items-center gap-2">

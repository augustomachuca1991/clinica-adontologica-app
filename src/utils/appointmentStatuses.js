export const STATUS_CONFIG = {
  ...
  "in-progress": { label: "En curso", bg: "bg-violet-50", border: "border-l-violet-500", text: "text-violet-700" },
  ...
  "no-show": { label: "No se presentó", bg: "bg-gray-100", border: "border-l-gray-400", text: "text-gray-500" },
};
